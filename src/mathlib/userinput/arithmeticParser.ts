	...
	public closed(_p?: number): ClosedContext {
		...
		try {
			...
			case 13:
				...
				this.state = 27;
				(localctx as IntegralContext)._integrand = this.closed(5);
				}
				break;
			case 14:
				{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.state = 37;
						(localctx as DivisionContext)._right = this.closed(5);
						}
						break;
					case 2:
						{
						...
						this.state = 40;
						(localctx as PowerContext)._right = this.closed(4);
						}
						break;
					case 3:
						{
						...
						this.state = 45;
						(localctx as ProductContext)._right = this.closed(3);
						}
						break;
					}
					}
