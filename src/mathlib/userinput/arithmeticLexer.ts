...
export default class arithmeticLexer extends Lexer {
    ...
    constructor(input: CharStream) {
        ...
        this._interp = new LexerATNSimulator(
            this,
            arithmeticLexer._ATN,
            arithmeticLexer.DecisionsToDFA,
    ...
    public static get _ATN(): ATN {
        if (!arithmeticLexer.__ATN) {
            arithmeticLexer.__ATN = new ATNDeserializer().deserialize(
    ...
    static DecisionsToDFA = arithmeticLexer._ATN.decisionToState.map(
