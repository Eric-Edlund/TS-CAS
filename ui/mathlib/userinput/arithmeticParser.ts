...
export default class arithmeticParser extends Parser {
    ...
    constructor(input: TokenStream) {
        ...
        this._interp = new ParserATNSimulator(
            this,
            arithmeticParser._ATN,
            arithmeticParser.DecisionsToDFA,
            new PredictionContextCache()
        )
    }
    // @RuleVersion(0)
    public equation(): EquationContext {
        let localctx: EquationContext = new EquationContext(
            this,
            this._ctx,
            this.state
        )
    ...
    public closed(_p?: number): ClosedContext {
        ...
        let localctx: ClosedContext = new ClosedContext(
            this,
            this._ctx,
            _parentState
        )
                    ...
                    case 13:
                        {
                            ...
                            this.state = 27
                            ;(localctx as IntegralContext)._integrand =
                                this.closed(5)
                        }
                        break
                    case 14:
                                ...
                                case 1:
                                    {
                                        ...
                                        ;(localctx as DivisionContext)._left =
                                            _prevctx
                                        this.pushNewRecursionContext(
                                            localctx,
                                            _startState,
                                            arithmeticParser.RULE_closed
                                        )
                                        this.state = 35
                                        ...
                                        this.state = 37
                                        ;(localctx as DivisionContext)._right =
                                            this.closed(5)
                                    }
                                    break
                                case 2:
                                    {
                                        localctx = new PowerContext(
                                            this,
                                            new ClosedContext(
                                                this,
                                                _parentctx,
                                        ...
                                        ;(localctx as PowerContext)._left =
                                            _prevctx
                                        this.pushNewRecursionContext(
                                            localctx,
                                            _startState,
                                        ...
                                        this.state = 40
                                        ;(localctx as PowerContext)._right =
                                            this.closed(4)
                                    }
                                    break
                                case 3:
                                    {
                                        localctx = new ProductContext(
                                            this,
                                            new ClosedContext(
                                                this,
                                                _parentctx,
                                        ...
                                        ;(localctx as ProductContext)._left =
                                            _prevctx
                                        this.pushNewRecursionContext(
                                            localctx,
                                            _startState,
                                        ...
                                        if (_la === 6) {
                                            {
                                                this.state = 42
                                                this.match(
                                                    arithmeticParser.TIMES
                                                )
                                            }
                                        }

                                        this.state = 45
                                        ;(localctx as ProductContext)._right =
                                            this.closed(3)
                                    }
                                    break
                            }
    ...
    public right_closed(_p?: number): Right_closedContext {
        ...
        let _parentctx: ParserRuleContext = this._ctx
        let _parentState: number = this.state
        let localctx: Right_closedContext = new Right_closedContext(
            this,
            this._ctx,
            _parentState
        )
        ...
        this.enterRecursionRule(
            localctx,
            6,
            arithmeticParser.RULE_right_closed,
            _p
        )
        let _la: number
        try {
            ...
            this.enterOuterAlt(localctx, 1)
            {
                ...
                switch (this._input.LA(1)) {
                    ...
                    case 15:
                        {
                            localctx = new ClosedIsRight_ClosedContext(
                                this,
                                localctx
                            )
                            this._ctx = localctx
                    ...
                    case 5:
                        {
                            localctx = new UnaryOnExpressionContext(
                                this,
                                localctx
                            )
                            this._ctx = localctx
                ...
                while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
                    if (_alt === 1) {
                        ...
                        _prevctx = localctx
                        {
                            {
                                localctx =
                                    new Right_ClosedImplicitProductContext(
                                        this,
                                        new Right_closedContext(
                                            this,
                                            _parentctx,
                                            _parentState
                                        )
                                ...
                                ;(
                                    localctx as Right_ClosedImplicitProductContext
                                )._left = _prevctx
                                this.pushNewRecursionContext(
                                    localctx,
                                    _startState,
    ...
    public open(_p?: number): OpenContext {
        ...
        let _parentctx: ParserRuleContext = this._ctx
        let _parentState: number = this.state
        let localctx: OpenContext = new OpenContext(
            this,
            this._ctx,
            _parentState
        )
    ...
    public relop(): RelopContext {
        let localctx: RelopContext = new RelopContext(
            this,
            this._ctx,
            this.state
        )
    ...
    public sempred(
        ...
        switch (ruleIndex) {
            ...
            case 3:
                return this.right_closed_sempred(
                    localctx as Right_closedContext,
                    predIndex
                )
            case 4:
    ...
    private closed_sempred(
        localctx: ClosedContext,
        predIndex: number
    ): boolean {
        switch (predIndex) {
            case 0:
    ...
    private right_closed_sempred(
        localctx: Right_closedContext,
        predIndex: number
    ): boolean {
        switch (predIndex) {
            case 3:
    ...
    public static get _ATN(): ATN {
        if (!arithmeticParser.__ATN) {
            arithmeticParser.__ATN = new ATNDeserializer().deserialize(
    ...
    static DecisionsToDFA = arithmeticParser._ATN.decisionToState.map(
